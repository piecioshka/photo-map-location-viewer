...
const MESSAGES = {
  en: {
    ...
    privacyFooter:
      "No accounts and no server of ours. Anonymous visit statistics (Google Analytics) only if you accept cookies.",
  ...
  pl: {
    ...
    privacyFooter:
      "Bez kont i bez naszego serwera. Anonimowe statystyki odwiedzin (Google Analytics) tylko po akceptacji ciasteczek.",
