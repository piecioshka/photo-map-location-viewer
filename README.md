...
- 🔎 Tap a marker to see a preview, the file name, the capture date and the exact coordinates (linked to Google Maps, native maps app on mobile)
- 🖼️ A magnifier button on the preview opens the untouched original photo in a new tab
